...
import { boolean, index, integer, jsonb, numeric, pgTable, timestamp, uuid } from 'drizzle-orm/pg-core';
...
import { estadoCitaEnum, metodoPagoEnum, origenCitaEnum, tstzrange } from './_shared';
